...
- **Seasonal Power Design:** Intended April–October power is three 25.6V, 6Ah LiFePO4 modules in parallel (25.6V, 18Ah, 460.8Wh nominal), with a candidate 100W 24V solar panel and compatible MPPT controller. The recovered BatteryHookup listing has no battery manufacturer part number; its specified Molex VersaBlade service interface is documented in `BOM-ESP32S3.md`. Do not finalize equipment until BMS parallel approval and field-load measurements are available.
